"""Helpers shared by the icil-policy tests: demonstrations, a probe policy, a served policy."""
...
class Probe:
    ...
    def act(self, observation):
        ...
        state = {
            "cwd": os.getcwd(),
            "path0": sys.path[0],
            "key_in_env": "ICIL_TEST_AUTHKEY" in os.environ,
