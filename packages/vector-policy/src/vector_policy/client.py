...
class RemotePolicy:
    """A policy served by `python -m vector_policy.serve` at `address`, reached with `authkey`."""
    ...
    def hello(self) -> dict[str, Any]:
        ...
        try:
            fields, _ = self._call("hello", {"client": f"vector-policy {__version__}"})
