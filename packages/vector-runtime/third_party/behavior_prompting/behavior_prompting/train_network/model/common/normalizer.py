...
from behavior_prompting.train_network.model.common.dict_of_tensor_mixin import DictOfTensorMixin
...
class Normalizer(LinearNormalizer):
    def __init__(self, params_dict=None):
        super().__init__(params_dict)
        self.prompt_normalizer = LinearNormalizer()

    def set_prompt_normalizer(self, prompt_normalizer: LinearNormalizer):
        self.prompt_normalizer = prompt_normalizer

    def get_prompt_normalizer(self):
        return self.prompt_normalizer
